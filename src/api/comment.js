...
const find = async () => await apiCaller('/comments');

const findById = async (id) => await apiCaller(`/comments/${id}`);
...
const __delete = async (id) => await apiCaller(`/comments/${id}`, 'delete');
